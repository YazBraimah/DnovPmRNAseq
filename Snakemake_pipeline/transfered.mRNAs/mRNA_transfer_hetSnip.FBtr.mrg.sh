...
#$ -q regular.q
#$ -j y
#$ -o mRNA_transfer_hetSnip.FBtr.mrg.$JOB_ID
#$ -N mRNA_transfer_hetSnip.FBtr.mrg
#$ -M ya76@cornell.edu
#$ -m be
#$ -pe bscb 1
#$ -binding linear:1
...
## copy bam files
cp /fs/cbsufsrv5/data1/ya76/Snakemake.Output.Folders/D.novamexicana_Tuxedo2_ggTrinity_RNAseq/Genome/annotated_eXpress/Female_H3_RT_1/bowtie2.bam /workdir/$USER/$JOB_ID/H3_RT_1.bowtie2.bam
cp /fs/cbsufsrv5/data1/ya76/Snakemake.Output.Folders/D.novamexicana_Tuxedo2_ggTrinity_RNAseq/Genome/annotated_eXpress/Female_H3_RT_2/bowtie2.bam /workdir/$USER/$JOB_ID/H3_RT_2.bowtie2.bam
cp /fs/cbsufsrv5/data1/ya76/Snakemake.Output.Folders/D.novamexicana_Tuxedo2_ggTrinity_RNAseq/Genome/annotated_eXpress/Female_H3_RT_3/bowtie2.bam /workdir/$USER/$JOB_ID/H3_RT_3.bowtie2.bam
cp /fs/cbsufsrv5/data1/ya76/Snakemake.Output.Folders/D.novamexicana_Tuxedo2_ggTrinity_RNAseq/Genome/annotated_eXpress/Female_C3_RT_1/bowtie2.bam /workdir/$USER/$JOB_ID/C3_RT_1.bowtie2.bam
cp /fs/cbsufsrv5/data1/ya76/Snakemake.Output.Folders/D.novamexicana_Tuxedo2_ggTrinity_RNAseq/Genome/annotated_eXpress/Female_C3_RT_2/bowtie2.bam /workdir/$USER/$JOB_ID/C3_RT_2.bowtie2.bam
cp /fs/cbsufsrv5/data1/ya76/Snakemake.Output.Folders/D.novamexicana_Tuxedo2_ggTrinity_RNAseq/Genome/annotated_eXpress/Female_C3_RT_3/bowtie2.bam /workdir/$USER/$JOB_ID/C3_RT_3.bowtie2.bam
...
## copy reference
cp /fs/cbsufsrv5/data1/ya76/Snakemake.Output.Folders/D.novamexicana_Tuxedo2_ggTrinity_RNAseq/gffread_annotated_transcriptome/gffread_annotated_transcripts.fa .
samtools faidx gffread_annotated_transcripts.fa

## copy gene list:
cp /home/ya76/GitHub_Repositories/D.novamexicana_Tuxedo2_ggTrinity_RNAseq/transfered.mRNAs/transferred.mRNA.candidates.IDs.FBtr.list  .

## make bam list
ls -1 *RT.bam > bam.list

hetSnipper.pl transferred.mRNA.candidates.IDs.FBtr.list bam.list gffread_annotated_transcripts.fa candidate.male-transferred.mRNAs.FBtr.mrg

### run vcftools stuff:
cd candidate.male-transferred.mRNAs.FBtr.mrg
...
cp -r /workdir/$USER/$JOB_ID/candidate.male-transferred.mRNAs.FBtr.mrg /fs/cbsufsrv5/data1/ya76/Snakemake.Output.Folders/D.novamexicana_Tuxedo2_ggTrinity_RNAseq/Trinity/pasa/transferred_transcripts
